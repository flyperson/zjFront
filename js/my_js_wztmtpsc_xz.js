...
mui.plusReady(function(){
	...
	function mywztm(id,wztm,i,hehe){
		...
		ul.innerHTML = '<li id="l'+num+'" class="mui-table-view-cell"><img id="t'+num+'" class="mui-media-object mui-pull-right" src="../images/wztmzj.jpg" style="width:50px;height:50px;"><div class="mui-media-body">'+wztm+'</div><p>部位：'+hehe+'</p></li>'
